...
namespace ERPManagementSystem.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public ProductController(IConfiguration configuration)
        {
            ...
            WorkPath = _configuration["WorkPath"] + "產品";
        ...
        /// 產品資訊新增
        /// </summary>
        /// <param name="productSetting">公司資訊物件</param>
        /// <returns></returns>
        [HttpPost]
        ...
        /// 廠商資訊更新
        /// </summary>
        /// <param name="productSetting">廠商資訊物件</param>
        /// <returns></returns>
        [HttpPost]
        ...
        /// 廠商附件檔案更新
        /// </summary>
        /// <param name="ProductNumber">公司編碼</param>
        /// <param name="ProductName">公司名稱</param>
        /// <param name="AttachmentFile">附件檔案</param>
        /// <param name="FileExtension">副檔名</param>
        /// <returns></returns>
        [HttpPost]
        [Route("/api/UpdateProductAttachmentFile")]
        public IActionResult PostProductAttachmentFile(string ProductNumber, string ProductName, IFormFile AttachmentFile, string FileExtension)
        {
            try
            {
