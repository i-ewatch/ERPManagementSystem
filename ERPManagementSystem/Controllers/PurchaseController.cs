...
namespace ERPManagementSystem.Controllers
{
    ...
    public class PurchaseController : ControllerBase
    {
        ...
        [HttpGet]
        public List<PurchaseSetting> GetPurchase()
        {
        ...
        public List<PurchaseSetting> GetPurchase(int PurchaseFlag)
        {
            List<PurchaseSetting> result = new List<PurchaseSetting>();
            List<PurchaseSubSetting> Sub = new List<PurchaseSubSetting>();
            try
        ...
        public List<PurchaseSetting> GetPurchase(int PurchaseFlag, string PurchaseNumber)
        {
            List<PurchaseSetting> result = new List<PurchaseSetting>();
            List<PurchaseSubSetting> Sub = new List<PurchaseSubSetting>();
            try
        ...
        [HttpPost]
        public List<PurchaseSetting> PostPurchase([FromBody] PurchaseSetting purchaseSetting)
        {
            List<PurchaseSetting> result = new List<PurchaseSetting>();
        ...
        [HttpPut]
        public IActionResult UpdatePurchase(PurchaseSetting purchaseSetting)
        {
            try
            {
                int DateMainIndex = 0;
        ...
        public IActionResult DeletePurchase(int PurchaseFlag, string PurchaseNumber)
        {
            try
            {
                int DateMainIndex = 0;
